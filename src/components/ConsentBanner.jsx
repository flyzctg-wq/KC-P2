        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs" style={{ color: C.onSurfaceVariant }}>
              ...
              <button onClick={() => setExpanded(e => !e)} aria-expanded={expanded} className="font-semibold underline" style={{ color: C.primary }}>
          ...
          <button onClick={decline} aria-label="Decline cookie consent" className="p-1 rounded-full shrink-0" style={{ color: C.outline }}><X size={14} /></button>
        </div>
