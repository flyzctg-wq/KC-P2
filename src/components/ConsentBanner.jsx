      ...
      <div className="rounded-2xl p-4 shadow-lg" style={{ backgroundColor: C.surface, border: `1px solid ${C.outlineVariant}` }}>
        <div className="flex items-start gap-3">
          ...
          <button
            ...
            className="p-1 rounded-full shrink-0 hover:bg-black/5 dark:hover:bg-white/5 transition-colors focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:outline-none"
